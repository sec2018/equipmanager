        ...
        */
        ...
        var core = {
            ...
            createProgressBar: function (values, days, cls, desc, label, dataObj) {
                ...
                var bar = $('<div class="bar" title="'+label+'"><div class="fn-label"><span class="gantt-txt">'+label+'</span></div><div class="fn-progress" style="width: '+progress+'%;"></div></div>')
            ...
            waitToggle: function (element, show, fn) {
                if (show) {
                    ...
                    if (!element.loader) {
                        ...
                        + '<div class="fn-gantt-loader-spinner"><span><img  width="100" height="100"></span></div></div>');
                    }
